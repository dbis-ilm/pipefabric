...
if(BUILD_USE_CASES)
  ...
  if(NOT linroad_POPULATED)
    ...
    file(COPY ${PROJECT_SOURCE_DIR}/src/usecases/LinearRoad/DataProvider/CMakeLists.txt
...
if(USE_NVM_TABLES)
  ...
  pkg_check_modules(PMDK REQUIRED libpmem>=1.5 libpmemobj++>=1.5)
